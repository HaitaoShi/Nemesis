...
1.  In review section, it is often used as a place to ask vendors questions. And many reviews have been deleted (e.g. deleted at 2022-04-23 16:59:51 UTC by /u/Francis )
    ...
    2.  Dosage and experience
        ...
        1.  How much to use?
        2.  100 mg are good for a K-hole experience?
        3.  How much would someone need to take of them to have an meth like effect? Or is this stuff totally different? How is it best consumed, just as a pill or crunched and snorted? Have no experience with it but want to try it (00887, Pos. 41-45) )
        4.  How are the Teslas? Do they give you a good clean roll? (01025, Pos. 58-59)
        5.  Have you tried squirting a bit of it up your nose with an oral syringe? (00314, Pos. 125)

    3.  Purity: (Are these oxys 100% nothing else In them? )

    4.  Freshness (is it still fresh? I made a mistake of ordering from a vendor and he sent very

        dry,brittle weed. it was very lifeless to smoke y'a know? Thanks!)

    5.  Potency: Is this the same as the other 30 mg oxy you sell? Is it strong or weak? I'm used to fentanyl so if I buy 1000 pills I want to make sure it will be strong (00926, Pos. 48-49)

    6.  Shipment (speed, location, successful delivery rate, when to arrive.) (e.g. Do you also ship to Italy? what's the probability of successful delivery to india? whats the quickest u can get to the uk delivery please )

    7.  Availability (e.g. Have you got also ketamin 1000mg/10ml? )

    8.  Asking about the possibility to start with small transactions. (e.g., Is there any way I can maybe purchase like 50 so I can try your product out before committing to buying 500 or 1000. Is that possible? (01058, Pos. 97-99))

    9.  Asking for samples (Can you send any samples of your H so I can see what I like more ? Pls and thank u for ur time (00727, Pos. 36-38)

    10. Asking for discounts (since you are a new vendor, are you offering any discounts on the carts?? (00669, Pos. 49))

    11. The trustworthiness of the market (e.g. Is this a trusted market ? i really want to get these pills )

2.  <div>

    The same reviews appear on posts with different vendor names and different drugs!

    > **Firefly (00366, Pos. 8) selling Ketamine Solution**
    >
    > **straightfromnl (00903, Pos. 8) Selling LSD**

    Again, I realise that these reviews are vendor-specific, so it's hard to know which product the reviewer is referring to if they don't make it clear.
...
5.  Extra info (soldiers are potential buyers of oxy)
